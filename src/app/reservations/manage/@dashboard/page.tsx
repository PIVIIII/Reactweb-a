...
import { dbConnect } from "@/db/dbConnenct"
...

            {
                ...
                <form action={addCar}>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block test-gray-700 pr-4" htmlFor="model">
                            Model</label>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block test-gray-700 pr-4" htmlFor="desc">
                            Description</label>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block test-gray-700 pr-4" htmlFor="picture">
                            Picture</label>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block test-gray-700 pr-4" htmlFor="seats">
                            Seats</label>
                        ...
                        text-gray-700 focus:outline-none focus:border-blue-400'/>
                        <label className="w-auto block test-gray-700 pr-4 ml-4" htmlFor="doors">
                            Doors</label>
                        <input type="number" required id="doors" name="doors" placeholder='4'
                        min={0} max={8}
                        className='bg-white border-2 border-gray-200 rounded w-auto p-2
                        text-gray-700 focus:outline-none focus:border-blue-400'/>
                        <input type="checkbox" required id="automatic" name="automatic" 
                        className="ml-5 mr-2"/><span>Auto</span>
                    </div>
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block test-gray-700 pr-4" htmlFor="largebags">
                            Large Bags</label>
                        <input type="number" required id="largebags" name="largebags" placeholder='2'
                        min={0} max={10}
                        className='bg-white border-2 border-gray-200 rounded w-auto p-2
                        text-gray-700 focus:outline-none focus:border-blue-400'/>
                        <label className="w-auto block test-gray-700 pr-4 ml-4" htmlFor="smallbags">
                            Small Bags</label>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block test-gray-700 pr-4" htmlFor="dayRate">
                            Rate</label>
